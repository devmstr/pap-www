...
type FormData = z.infer<typeof IdpSchema>

interface EditIdpFormProps {
  data: FormData
  params: { lang: Locale; id: string }
}

export const EditIdpForm: React.FC<EditIdpFormProps> = ({
  data,
  params: { lang, id }
}: EditIdpFormProps) => {
  ...
  async function onSubmit(formData: FormData) {
    try {
      ...
      const response = await api.patch(`/idps/${id}`, formData)
              ...
              <FormItem className="grid w-full items-center gap-1.5">
                ...
                <FormControl>
                  <Selector
                    ...
                    {...field}
                    value={type ? type : OBJECTIVE_TYPES[0]}
              ...
              <FormItem>
                ...
                <FormControl>
                  <DatePicker
                    ...
                    isDisabled={session?.user.role != 'HR'}
                  />
                </FormControl>
                <FormMessage />
              </FormItem>

...
interface SuccessionTableActionsProps {
  id: string
}

export function SuccessionTableActions({ id }: SuccessionTableActionsProps) {
  ...
  const handleDelete = async (successionId: string) => {
    try {
      setIsDeleting(true)
      const { data } = await api.delete('/succession/' + successionId)
      refresh()
    } catch (error: any) {
      toast({
    ...
    <>
      ...
      <AlertDialog open={showDeleteAlert} onOpenChange={setShowDeleteAlert}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              Are you sure you want to delete this Succession Plan?
            </AlertDialogTitle>
            <AlertDialogDescription>
